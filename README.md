...
This plugin was originally made to be used along with [CoreProtect](https://github.com/PlayPro/CoreProtect) so it doesn't provide some things that CoreProtect provides (like blocks placed/broken, entities killed, etc.). Getting CoreProtect is strongly suggested as it is an amazingly useful moderation tool.  
